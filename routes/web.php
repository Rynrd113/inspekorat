...
Route::middleware('admin.logout.public')->group(function () {
    ...
    Route::get('/galeri/album/{slug}', [PublicController::class, 'album'])->name('public.album');
    ...
    Route::get('/review-opd/{reviewOpd}', [PublicController::class, 'reviewOpdShow'])->name('public.review-opd.show');
});
