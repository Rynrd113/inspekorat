...
class DokumenController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'file_dokumen' => 'required|file|mimes:pdf,doc,docx,xls,xlsx,ppt,pptx,zip,rar,txt|max:10240',
    ...
    public function update(Request $request, \App\Models\Dokumen $dokumen)
    {
        $validated = $request->validate([
            ...
            'nomor_dokumen' => 'nullable|string|max:100',
            'tanggal_terbit' => 'required|date',
            'file_dokumen' => 'nullable|file|mimes:pdf,doc,docx,xls,xlsx,ppt,pptx,zip,rar,txt|max:10240',
