...
<div class="min-h-screen bg-gray-50">
    ...
    <section class="bg-white py-4 border-b border-gray-200">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <form method="GET" action="{{ route('public.review-opd') }}" class="flex flex-wrap gap-3 items-center">
                ...
                <button type="submit"
                        class="px-5 py-2.5 bg-blue-700 text-white text-sm font-medium rounded-lg hover:bg-blue-800 transition-colors">
    ...
    <section class="py-6">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            @endphp
            <div class="flex gap-4 mb-6" style="display:flex; flex-direction:row;">
                <div class="bg-white rounded-lg shadow-sm border-l-4 border-yellow-400 px-5 py-4 flex items-center gap-4 flex-1">
                ...
                <div class="bg-white rounded-lg shadow-sm border-l-4 border-blue-400 px-5 py-4 flex items-center gap-4 flex-1">
                ...
                <div class="bg-white rounded-lg shadow-sm border-l-4 border-green-400 px-5 py-4 flex items-center gap-4 flex-1">
                    ...
                    <table class="min-w-full divide-y divide-gray-200 text-sm">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-4 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Nama OPD</th>
                                <th class="px-4 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Tahun</th>
                                <th class="px-4 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Tanggal Review</th>
                                <th class="px-4 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Status</th>
                                <th class="px-4 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Hasil</th>
                                <th class="px-4 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Dok.</th>
                            </tr>
                        </thead>
